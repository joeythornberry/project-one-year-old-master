...
locations = {"battle button":(0.15,0.78),"target":(0.22,0.32),"card 1":(0.29,0.92),"card 2":(0.46,0.92),"card 3":(0.64,0.92),"card 4":(0.84,0.92),"seasonal button":(0.84,0.99),"get rid of popup":(0.93,0.49),"home button":(0.47,0.99)}
...
coerce_window_size()
locations = {}
locations["test"] = find_location.get_location_relative_to_window()
print(locations["test"])
load_location_pixels()
pyautogui.moveTo(locations["test"])
'''
